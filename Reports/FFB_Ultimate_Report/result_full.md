...
|:----:|:-----:|:--------:|:---------:|:------:|:------:|
| 42 | 0.873 | 0.370 | 0.884 | 0.727 | [exp_a1_rgb_test.txt](artifacts/kaggleoutput/exp_a1_rgb_test.txt) |
| 123 | 0.873 | 0.369 | 0.808 | 0.790 | [exp_a1_rgb_test.txt](artifacts/kaggleoutput/exp_a1_rgb_test.txt) |
...
| Seed | mAP50 | mAP50-95 | Precision | Recall | Source |
|:----:|:-----:|:--------:|:---------:|:------:|:------:|
| 42 | 0.640 | 0.216 | 0.643 | 0.667 | [exp_a2_depth_test.txt](artifacts/kaggleoutput/exp_a2_depth_test.txt) |
| 123 | 0.615 | 0.235 | 0.652 | 0.581 | [exp_a2_depth_test.txt](artifacts/kaggleoutput/exp_a2_depth_test.txt) |
...
| Seed | mAP50 | mAP50-95 | Precision | Recall | Source |
|:----:|:-----:|:--------:|:---------:|:------:|:------:|
| 42 | 0.875 | 0.378 | 0.787 | 0.811 | [exp_a3_rgbd_test.txt](artifacts/kaggleoutput/exp_a3_rgbd_test.txt) |
| 123 | 0.862 | 0.380 | 0.772 | 0.804 | [exp_a3_rgbd_test.txt](artifacts/kaggleoutput/exp_a3_rgbd_test.txt) |
...
| Seed | mAP50 | mAP50-95 | Precision | Recall | Source |
|:----:|:-----:|:--------:|:---------:|:------:|:------:|
| 42 | 0.804 | 0.511 | 0.778 | 0.747 | [exp_b1_ripeness_test.txt](artifacts/kaggleoutput/exp_b1_ripeness_test.txt) |
| 123 | 0.797 | 0.517 | 0.796 | 0.731 | [exp_b1_ripeness_test.txt](artifacts/kaggleoutput/exp_b1_ripeness_test.txt) |
...
| Seed | mAP50 | mAP50-95 | Precision | Recall | Source |
|:----:|:-----:|:--------:|:---------:|:------:|:------:|
| 42 | 0.873 | 0.422 | 0.793 | 0.810 | [ablation4_small_sgd_300e_test.txt](artifacts/kaggleoutput/ablation4_small_sgd_300e_test.txt) |
| 123 | 0.877 | 0.443 | 0.819 | 0.817 | [ablation4_small_sgd_300e_test.txt](artifacts/kaggleoutput/ablation4_small_sgd_300e_test.txt) |
...
| Seed | mAP50 | mAP50-95 | Precision | Recall | Source |
|:----:|:-----:|:--------:|:---------:|:------:|:------:|
| 42 | 0.918 | 0.415 | 0.822 | 0.838 | [ablation1_small_sgd_50e_test.txt](artifacts/kaggleoutput/ablation1_small_sgd_50e_test.txt) |
| 123 | 0.880 | 0.420 | 0.823 | 0.781 | [ablation1_small_sgd_50e_test.txt](artifacts/kaggleoutput/ablation1_small_sgd_50e_test.txt) |
...
| Seed | mAP50 | mAP50-95 | Precision | Recall | Source |
|:----:|:-----:|:--------:|:---------:|:------:|:------:|
| 42 | 0.860 | 0.382 | 0.747 | 0.838 | [ablation2_nano_adamw_50e_test.txt](artifacts/kaggleoutput/ablation2_nano_adamw_50e_test.txt) |
| 123 | 0.860 | 0.399 | 0.760 | 0.810 | [ablation2_nano_adamw_50e_test.txt](artifacts/kaggleoutput/ablation2_nano_adamw_50e_test.txt) |
...
| Seed | mAP50 | mAP50-95 | Precision | Recall | Source |
|:----:|:-----:|:--------:|:---------:|:------:|:------:|
| 42 | 0.824 | 0.367 | 0.838 | 0.724 | [ablation5_small_adamw_300e_test.txt](artifacts/kaggleoutput/ablation5_small_adamw_300e_test.txt) |
| 123 | 0.841 | 0.380 | 0.805 | 0.771 | [ablation5_small_adamw_300e_test.txt](artifacts/kaggleoutput/ablation5_small_adamw_300e_test.txt) |
...
| Seed | mAP50 | mAP50-95 | Precision | Recall | Source |
|:----:|:-----:|:--------:|:---------:|:------:|:------:|
| 42 | 0.851 | 0.354 | 0.773 | 0.810 | [ablation3_nano_sgd_300e_test.txt](artifacts/kaggleoutput/ablation3_nano_sgd_300e_test.txt) |
| 123 | 0.847 | 0.371 | 0.785 | 0.724 | [ablation3_nano_sgd_300e_test.txt](artifacts/kaggleoutput/ablation3_nano_sgd_300e_test.txt) |
...
├── exp_a1_rgb_test.txt             # A.1 RGB test results
├── exp_a2_depth_test.txt           # A.2 Depth test results
├── exp_a3_rgbd_test.txt            # A.3 RGBD test results
├── exp_b1_ripeness_test.txt        # B.1 Ripeness test results
├── ablation1_small_sgd_50e_test.txt    # Ablation 1 results
├── ablation2_nano_adamw_50e_test.txt   # Ablation 2 results
├── ablation3_nano_sgd_300e_test.txt    # Ablation 3 results
├── ablation4_small_sgd_300e_test.txt   # Ablation 4 results
├── ablation5_small_adamw_300e_test.txt # Ablation 5 results
